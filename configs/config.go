...
var SUPPLIER_MICRO_GRPC_PORT = os.Getenv("PROBLEMS_GRPC_PORT")
var SUPPLIER_MICRO_SERVICE = os.Getenv("PROBLEMS_SERVICE")
var SUPPLIER_MICRO_CERT_NAME = os.Getenv("PROBLEMS_CERT_NAME")
var SUPPLIER_MICRO_CERTIFICATE = CERT_PATH + PROBLEMS_CERT_NAME
